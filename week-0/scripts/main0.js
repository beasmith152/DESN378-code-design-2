...
/*
  ...
  2. The welcome message is standardly set through local storage of what name was used last in case no input is set. Second, if an name is set it changes the content of the h1 where it is positioned to that name. This is all done through the button. 
​
